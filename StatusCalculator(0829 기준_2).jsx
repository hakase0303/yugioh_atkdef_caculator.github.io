...
.yc-var{grid-column:2/8;display:flex;flex-wrap:wrap;align-items:flex-end;gap:10px;
  margin:2px 0 4px;padding:0;font-size:11.5px;color:var(--muted);}

.yc-off{grid-column:8/-1;display:flex;flex-wrap:wrap;align-items:flex-end;gap:10px;
  margin:2px 0 4px;padding:0;font-size:11.5px;color:var(--muted);}
