...
.yc-theme{flex:0 0 auto;width:36px;height:36px;border:1px solid var(--edge);border-radius:9px;
...
.yc-row{display:grid;
  grid-template-columns:24px minmax(0,1.7fr) minmax(0,1fr) 72px 64px 70px;
  gap:8px;align-items:center;margin-bottom:8px;border-radius:6px;}
@media(max-width:560px){
  .yc{padding:18px 12px 44px;}
  .yc-panel{padding:12px;}
  .yc-row{grid-template-columns:14px minmax(0,1.5fr) minmax(0,1fr) 38px 46px 54px;gap:4px;}
  .yc-row .yc-sel,.yc-row .yc-input{padding:7px 2px;font-size:10.5px;}
  .yc-row .yc-chip{font-size:9px;padding:7px 0;}
  .yc-row .yc-btn{font-size:11px;padding:6px 0;}
  .yc-row .yc-mini{gap:2px;}
  .yc-row .yc-n{font-size:10px;}
}
...
.yc-tabs{display:flex;gap:16px;margin-top:13px;border-bottom:1px solid var(--edge);}
              ...
              return (
                ...
                >
                  ...
                  <div className="yc-mini">
                    <button
                      className="yc-btn yc-grip" draggable
