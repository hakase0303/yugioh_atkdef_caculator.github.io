...
@media(max-width:560px){
  ...
  /* 일곱 칸을 한 줄에 넣으면 글자가 잘린다. 폭이 모자라면 접히게 둔다. */
  .yc-row{display:flex;flex-wrap:wrap;gap:5px;align-items:center;}
  .yc-row .yc-sel,.yc-row .yc-input{padding:7px 4px;font-size:11.5px;}
  .yc-c-n{width:14px;font-size:11px;}
  .yc-c-t{flex:0 0 62px;font-size:10px;padding:7px 0;}
  .yc-c-f{flex:1 1 88px;min-width:0;}
  .yc-c-g{flex:1 1 108px;min-width:0;}
  .yc-c-v{flex:0 0 54px;}
  .yc-c-o{flex:1 1 116px;min-width:0;}
  .yc-c-m{flex:0 0 58px;margin-left:auto;}
